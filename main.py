...
while True:
    day = conn.scalar(sa.text('SELECT MAX(day) FROM public.temp_readings_production'))
    ...
    with placeholder.container():
        ...
        with cols[1]:
            ...
            cols[1].dataframe(
                fetch_panda_frame(f"SELECT * FROM public.temp_readings_production WHERE day = {day} ORDER BY temperature DESC LIMIT 20"),
